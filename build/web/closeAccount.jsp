...
<html>
    ...
    <center>
        <h3 style="color: black; margin-left: 25px;">Close Account</h3>
        <br>
        ...
        <form action="CloseAccount" method="POST">
            ...
            <input name="submit" type="submit" value="Close Account" style="width:10%;"/>
        </form>
        <%
        } else {
        %>
        <div style="width:80%;text-align: center;height: 32px;font-size: 14px;font-family: verdana;background-color: lightsalmon;color: red; padding-top: 5px; ">
            <h4 style="margin-top: 3px;">Invalid Account Number or Account is already closed</h4>
        </div>
        <%
                }
            }
        ...
        %>
        <div style="width:80%;text-align: center;height: 32px;font-size: 14px;font-family: verdana;background-color: lightgreen;color: green; padding-top: 5px; ">
            <h4 style="margin-top: 3px;">Account Closed Successfully</h4>
        </div>
        <%
        } else if (msg.equals("error")) {
        %>
        <div style="width:80%;text-align: center;height: 32px;font-size: 14px;font-family: verdana;background-color: lightsalmon;color: red; padding-top: 5px; ">
            <h4 style="margin-top: 3px;">Account Close Failed</h4>
        </div>
        <%
                }
            }
