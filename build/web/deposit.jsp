...
<html>
    ...
    <center>
        <h3 style="color: black; margin-left: 25px;">Deposit</h3>
        <br>
        ...
        <form action="Deposit" method="POST">
            ...
            <table>
                ...
                <td><center><input name="amount" id="amount" placeholder="Enter Deposit Amount" type="text" required="required"/></center></td>
                </tr>
            </table>
