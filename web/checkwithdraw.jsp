...
<html>
    ...
    <center>
        <h3 style="color: black; margin-left: 25px;">Check Withdraw</h3>
        <br>
        <%                String clk = request.getParameter("clk");
            Long aid;
        %>
        <form action="checkwithdraw.jsp" method="POST">
        ...
        <%
            if (clk != null) {
                ...
                if (rs.next()) {
        %>
        <form action="CheckWithdraw" method="POST">
