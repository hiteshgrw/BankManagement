...
<html>
    ...
    <body>
        ...
        <h1 align="center">Welcome to Net Banking </h1>
        <hr>
        <div style="width: 300px; height: 300px; margin: auto; margin-top: 150px;margin-left: 900px; padding: 10px; background-color: rgba(255,255,255,0.5)">
            ...
            <h4 style="text-align: center; color: purple; font-family: serif; font-size: 14px;">CUSTOMER LOGIN</h4><br>
            <form action="CustomerLogin" method="POST" style="text-align: center">
                User ID<br>
