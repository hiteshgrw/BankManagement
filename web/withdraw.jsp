...
<html>
    ...
    <center>
        <h3 style="color: black; margin-left: 25px;">Withdraw</h3>
        <br>
        ...
        <form action="Withdraw" method="POST">
            ...
            <table>
                ...
                <td><center><input name="amount" id="amount" placeholder="Enter Wtihdrawl Amount" type="text" required="required"/></center></td>
                </tr>
            </table>
            <input name="submit" type="submit" value="Withdraw" style="width:10%;"/>
        </form>
        <%
        } else {
        %>
        ...
        %>
        <div style="width:80%;text-align: center;height: 32px;font-size: 14px;font-family: verdana;background-color: lightgreen;color: green; padding-top: 5px; ">
            <h4 style="margin-top: 3px;">Withdrawn Successfully</h4>
        </div>
        <%
        } else if (msg.equals("error")) {
        %>
        <div style="width:80%;text-align: center;height: 32px;font-size: 14px;font-family: verdana;background-color: lightsalmon;color: red; padding-top: 5px; ">
            <h4 style="margin-top: 3px;">Withdrawl Failed</h4>
        </div>
        <%
                }
            }
