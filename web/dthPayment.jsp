...
<html>
    ...
    <body>
        ...
        <h2 style="color: black; margin-left: 25px; text-align: center;">DTH RECHARGE</h2> <br><br>
    <center>
        ...
        <div style="width:80%;text-align: center;height: 32px;font-size: 14px;font-family: verdana;background-color: lightsalmon;color: red; padding-top: 5px; ">
            <h4 style="margin-top: 3px;">Recharge Failed</h4>
        </div>
        <%
                }
            }
        ...
        <div style="width: 100%; margin: auto; padding: 10px; background-color: rgba(255,255,255,0.5)">
            <form action="DTHPayment" method="POST">
                <table>
                    <tr>
                        <td><h4>Enter Customer ID</h4></td>
                    </tr>
                    <tr>
                        <td><center><input name="cnum" id="cnum" placeholder="Enter Customer ID" type="text" required="required"/></center></td>
                    </tr>
                    <tr>
                        <td><h4>Enter Phone Number</h4></td>
                    </tr>
                    <tr>
                        <td><center><input name="pnum" id="pnum" placeholder="Enter Phone Number" type="text" required="required"/></center></td>
                    </tr>
                    <tr>
